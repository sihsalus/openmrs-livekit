...
profile = PersonalityProfile(
    ...
    culture_connections=[
        "Al terminar el dato, agrega: '...y eso me recuerda algo de un juego: {culture_fact}'",
        ...
        "Cierra con orgullo gamer: '...y por eso los gamers somos los más listos. ¡GG!'",
    ...
    fact_categories=[
        ...
        {
            "id": "tech",
            "label": "tecnología y computadoras",
            "emoji": "💻",
    ...
    category_specifics={
        "animals": [
            ...
            "el pez globo (como un mob defensivo)",
            "la hormiga bala",
        ],
        "space": [
            "Saturno",
        ...
        "history": [
            ...
            "los ninjas",
            "la antigua Grecia (inventaron las Olimpiadas)",
            "los mongoles",
        ],
        "food": [
            "el chocolate",
        ...
        "languages": [
            ...
            "el finlandés",
            "el islandés",
            "los emojis como idioma moderno",
            "el código Morse",
            "Python (idioma de computadoras)",
            "los idiomas inventados de videojuegos",
        ],
        "sports": [
            "las Olimpiadas",
            "el fútbol",
            ...
            "el skateboarding",
            "los esports de League of Legends",
            "los campeonatos de Fortnite",
            "las competencias de speedrun",
            "el parkour",
            "los torneos de Roblox",
            "el gaming competitivo",
        ],
        "dinosaurs": [
            "el T-Rex",
            "el Velociraptor",
        ...
        "music": [
            "la música de Minecraft",
            "la música de Mario",
            "el violín",
            "la guitarra eléctrica",
            "el theremin (instrumento sin tocarlo)",
            "la batería electrónica",
            "los sintetizadores",
            "la música chiptune (hecha con sonidos de consola retro)",
            "las bandas sonoras de videojuegos",
            "los efectos de sonido en juegos",
        ],
        "gaming": [
            "la historia de Roblox",
            "la historia de Minecraft",
            "los primeros videojuegos",
            "Nintendo",
            "las consolas retro",
            "los Easter Eggs famosos",
            "los speedruns más locos",
            "los juegos más vendidos",
            "la evolución de los gráficos",
            "los bugs más famosos",
            "los personajes más icónicos",
            "cómo se hacen los videojuegos",
            "Fortnite",
            "Among Us",
            "los récords de gaming",
        ...
        "insects": [
            ...
            "las abejas",
            "las libélulas",
            "las cucarachas (sobreviven a todo como un jugador pro)",
        ...
        "tech": [
            ...
            "el código binario",
            "los servidores de juegos online",
            "los píxeles",
            "las pantallas OLED",
        ],
        "micro_world": [
