...
profile = PersonalityProfile(
    ...
    culture_connections=[
        ...
        "Cierra con orgullo K-pop exagerado: '...pero nada le gana a un buen comeback! DAEBAK!'",
    ...
    category_specifics={
        ...
        "space": [
            ...
            "asteroides",
            "Venus",
            "el cohete Nuri (cohete espacial coreano)",
            "satelites coreanos",
        ],
        "human_body": [
            "el cerebro",
        ...
        "ocean": [
            ...
            "los tiburones",
            "las haenyeo (buzadoras coreanas)",
            "las anguilas electricas",
            "los peces abisales",
            "la medusa inmortal",
            "los volcanes submarinos",
            "los pulpos del Pacifico",
            "el mar de Japon y el mar Amarillo",
        ],
        "history": [
            ...
            "los hwarang (guerreros coreanos)",
            "la tortuga acorazada geobukseon",
        ],
        "food": [
            "el kimchi",
            "el bibimbap",
            ...
            "el ramyeon coreano",
            "el bulgogi",
            "el helado de patata coreano",
            "el kimbap",
            "las Korean fried chicken",
            "el hotteok",
            "el bingsu (helado raspado coreano)",
            "el japchae",
            "el soju",
            "el tteok (pastel de arroz)",
            "el jjajangmyeon",
        ],
        "inventions": [
            "el telefono",
            ...
            "el GPS",
            "las pantallas OLED (Samsung)",
            "el hangul (alfabeto cientifico coreano)",
            "el ondol (calefaccion bajo suelo coreana)",
            "la tecnologia 5G",
        ],
        "weather": [
            "los rayos",
            ...
            "los volcanes",
            "los terremotos",
            "los monzones asiaticos",
            "los arcoiris",
            "la isla volcanica de Jeju",
            "las cuatro estaciones de Corea",
            "los cerezos en flor coreanos",
        ],
        "languages": [
            ...
            "el espanol",
            "el braille",
            "el lenguaje de senas",
            "el sistema honorificos del coreano",
            "las onomatopeyas coreanas",
        ],
        "sports": [
            "las Olimpiadas",
            "el futbol",
            "el taekwondo (creado en Corea)",
            "el ajedrez",
            "la natacion",
            "la arqueria coreana (dominan las Olimpiadas)",
            "los esports (Corea es la potencia mundial)",
            "el patinaje artistico (Kim Yuna)",
            "el badminton asiatico",
        ],
        "dinosaurs": [
            "el T-Rex",
            "el Velociraptor",
            ...
            "el Megalodon",
            "la extincion masiva",
            "el Tarbosaurus (primo asiatico del T-Rex)",
            "el Deinocheirus (descubierto en Mongolia)",
        ],
        "music": [
            "BTS y su impacto global",
            "BLACKPINK y sus records",
            "el gayageum (instrumento tradicional coreano)",
            "el violin",
            "el theremin",
            "la guitarra",
            "las ballenas cantoras",
            "los lightsticks de K-pop",
            "la produccion musical K-pop",
            "los idols multi-talento",
            "el sistema de entrenamiento K-pop",
        ],
        "kpop_korea": [
            "BTS",
            "BLACKPINK",
            "Stray Kids",
            "TWICE",
            "el sistema de trainees",
            "los comebacks",
            "las agencias K-pop",
            "el Hallyu (ola coreana)",
            "los K-dramas",
            "la moda coreana",
            "Seul",
            "los palacios reales de Corea",
            "la isla de Jeju",
            "la tecnologia coreana",
            "Samsung y la innovacion",
            "la comida callejera de Seul",
            "los cafes tematicos coreanos",
            "la DMZ (zona desmilitarizada)",
            "los festivales de K-pop",
        ],
        "insects": [
            ...
            "las aranas saltarinas",
            "las mantis religiosas",
            "las abejas",
            "los escarabajos ciervo de Asia",
            "las libelulas",
        ],
        "technology": [
            "los robots coreanos",
            ...
            "los drones",
            "la realidad virtual",
            "Hyundai y los coches del futuro",
            "Naver (el Google coreano)",
        ],
        "micro_world": [
            "los tardigrados",
            "las bacterias extremofilas",
            "las mitocondrias",
            "los virus",
            "los atomos",
        ...
        "records": [
            "el animal mas rapido",
            "el edificio mas alto",
            "la persona mas longeva",
            "el lugar mas frio",
            "la comida mas cara",
            "el instrumento mas raro",
