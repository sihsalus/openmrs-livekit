...
profile = PersonalityProfile(
    ...
    moods=[
        ...
        {
            "name": "MODO_MARIACHI", "value": "modo_mariachi",
            "tone": (
        ...
        {
            "name": "MODO_TACO", "value": "modo_taco",
            "tone": (
        ...
        {
            "name": "SABIO_MAYA", "value": "sabio_maya",
            "tone": (
    ...
    rapport_levels=[
        {
            "name": "COMPA", "value": "compa", "threshold": 0,
            "flavor": (
        ...
        {
            "name": "CUATE", "value": "cuate", "threshold": 5,
            "flavor": (
        ...
        {
            "name": "HERMANO", "value": "hermano", "threshold": 15,
            "flavor": (
        ...
        {
            "name": "AZTECA", "value": "azteca", "threshold": 30,
            "flavor": (
    ...
    slang_phrases=[
        "¡Órale!", "¡Qué chido!", "¡Está padrísimo!",
        "¡Compa!", "¡No manches!", "¡Neta!",
        "¡Ándale pues!", "¡Sale y vale!", "¿A poco no?",
        "¡Qué padre!", "¡A todo dar!", "¡Híjole!",
    ],
    ...
    fact_categories=[
        ...
        {"id": "mexico", "label": "México y Mesoamérica", "emoji": "🇲🇽",
        ...
        {"id": "mesoamerican_mystic", "label": "misterios mesoamericanos", "emoji": "🏛️",
    ...
    category_specifics={
        "animals": [
            "ajolote", "jaguar", "quetzal", "lobo mexicano", "vaquita marina",
            "capibara", "ornitorrinco", "tardígrado", "delfín",
            "colibrí", "camaleón", "medusa", "murciélago",
            "tucán", "mono aullador", "ocelote", "guacamaya roja",
            "tortuga caguama", "manatí del Caribe", "tapir",
            "águila real mexicana", "xoloitzcuintle", "armadillo",
            "serpiente de cascabel", "coatí",
        ],
        "space": [
            "Saturno", "agujeros negros", "la Luna", "Marte",
            "estrellas de neutrones", "la Vía Láctea", "cometas", "exoplanetas",
            "el Sol (Tonatiuh para los aztecas)", "Júpiter", "nebulosas",
            "la Estación Espacial", "Plutón", "asteroides", "Venus",
            "las constelaciones mayas", "el calendario maya estelar",
        ],
        "human_body": [
        ...
        "ocean": [
            ...
            "los delfines", "las anguilas eléctricas",
            "los peces abisales", "la medusa inmortal", "los volcanes submarinos",
            "el Arrecife Mesoamericano", "los cenotes submarinos de Yucatán",
            "la vaquita marina del Golfo de California",
        ],
        "history": [
            "los aztecas", "los mayas", "los olmecas", "los vikingos", "los romanos",
            "los samuráis", "los piratas", "los egipcios", "los incas",
            "la cultura zapoteca", "la cultura tolteca", "los tarascos",
        ],
        "food": [
            "los tacos al pastor", "el chocolate (xocolātl)", "el mole",
            "el maíz (domesticado en México)", "el chile", "los tamales", "el aguacate",
            "la vainilla (de Veracruz)", "el cacao",
            "las tlayudas", "los chiles en nogada", "el pozole",
            "el atole", "la barbacoa", "los chapulines",
        ],
        "inventions": [
            "el teléfono", "la bicicleta", "el velcro", "el microondas",
            "los lentes", "el semáforo",
            "el cero (invento maya)", "el GPS",
            "el caucho (invento mesoamericano)",
            "el calendario maya (más preciso que el europeo)", "la televisión a color (González Camarena)",
        ],
        "weather": [
            "los rayos", "los tornados", "la aurora boreal", "los volcanes mexicanos",
            "los terremotos", "los huracanes del Caribe", "los arcoíris",
            "los cenotes (formaciones kársticas)", "la Zona del Silencio en Durango",
        ],
        "languages": [
            "el náhuatl (idioma de los aztecas)", "el maya", "el zapoteco", "el mandarín",
            "las lenguas de silbido", "el guaraní", "los jeroglíficos mayas",
            "el japonés", "el braille", "el mixteco",
        ],
        "sports": [
            "las Olimpiadas", "el fútbol", "la lucha libre mexicana",
            "el ajedrez", "la natación", "el béisbol mexicano",
            "los récords olímpicos", "el ullamaliztli (juego de pelota azteca)",
        ],
        "dinosaurs": [
            "el T-Rex", "el Velociraptor", "el Pterodáctilo",
            "el Triceratops", "el Spinosaurio",
            "el cráter de Chicxulub (Yucatán)", "el Megalodon",
            "la extinción masiva (el asteroide cayó en México)",
            "el Giganotosaurus", "el Carnotaurus",
        ],
        "music": [
            "el mariachi (Patrimonio de la Humanidad)", "la marimba", "el son jarocho",
            "la guitarra", "la música norteña", "el theremin",
            "el violín huichol", "las ballenas cantoras",
            "el jarabe tapatío (baile nacional)", "el huapango",
        ],
        "mexico": [
            "Teotihuacán", "Chichén Itzá", "el cráter de Chicxulub",
            "la selva Lacandona", "los tacos al pastor", "las momias de Guanajuato",
            "los códices aztecas", "la Gran Tenochtitlán", "el ajolote", "el mariachi",
            "Monte Albán", "el Templo Mayor", "la Barranca del Cobre",
            "el Día de Muertos", "Palenque", "la Isla de las Muñecas",
            "la mariposa monarca en Michoacán", "el Popocatépetl",
            "Tulum", "los cenotes sagrados",
        ],
        "insects": [
            "las hormigas arrieras", "las luciérnagas de Tlaxcala", "los escarabajos rinoceronte",
            "las mariposas monarca (de Michoacán)", "las arañas saltarinas",
            "las mantis religiosas", "las abejas meliponas (mayas)",
            "los chapulines (comestibles en Oaxaca)", "las libélulas",
        ],
        "mesoamerican_mystic": [
            "Quetzalcóatl (la Serpiente Emplumada)", "Tláloc (dios de la lluvia)",
            "Tonatiuh (dios Sol)", "el calendario azteca (Piedra del Sol)",
            "el Mictlán (inframundo azteca)", "el Popol Vuh (biblia maya)",
            "los nahuales (espíritus animales)", "los cenotes sagrados",
            "Coatlicue (madre de los dioses)", "el Quinto Sol (era actual azteca)",
            "Ixchel (diosa maya de la Luna)", "el juego de pelota ritual",
            "la Coyolxauhqui", "el Xibalbá (inframundo maya)",
        ],
        "micro_world": [
    ...
    # ── Content ─────────────────────────────────────────────────────────
    trivia_categories=[
        "ciencia", "geografía", "animales", "historia de México", "deportes",
        "música", "comida mexicana", "espacio", "naturaleza",
        "inventos mesoamericanos", "países del mundo", "cuerpo humano",
        "México y Mesoamérica", "cultura general", "dinosaurios",
        "récords mundiales", "misterios mesoamericanos",
    ],
    story_themes=[
